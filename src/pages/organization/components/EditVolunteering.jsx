...
function EditVolunteering({ Volunteering, refetch }) {
  ...
  const onSubmit = async () => {
    ...
    const response = await api.patch(`volunteering/${Volunteering.id}`, newVolunteering);
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Editar voluntariado</Modal.Title>
        </Modal.Header>
            ...
            <Card.Body>
              ...
              <Row>
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ref={projectName}
                      defaultValue={Volunteering.projectName}
                      type="text"
                ...
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="date"
                      ref={startDate}
                      defaultValue={Volunteering.startDate}
                ...
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      type="date"
                      ref={finishDate}
                      defaultValue={Volunteering.finishDate}
                ...
                <Col>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                      ...
                      defaultValue={Volunteering.category}
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  defaultValue={Volunteering.quotas}
                />
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  defaultValue={Volunteering.requirements}
                />
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  defaultValue={Volunteering.contact}
                />
